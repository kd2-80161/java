...
public class Book implements Serializable {
	...
	public static void main(String[] args) {
		...
		while (choice != 0) {
			...
			System.out.println("8. Save Book from file");
			System.out.println("9. Save Book in file Object");
			System.out.println("10. Load Book from file Object");
